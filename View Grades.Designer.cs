namespace MathMind
{
   partial class ViewGrades
   {
      ...
      private void InitializeComponent()
      {
         ...
         Results.Location = new Point(161, 591);
         Results.Name = "Results";
         Results.Size = new Size(250, 49);
         Results.TabIndex = 19;
         Results.Text = "Quiz Review";
         ...
         NameLabel.Size = new Size(322, 41);
         NameLabel.TabIndex = 0;
         NameLabel.Text = "Name Quizzes Record";
         // 
         // export
         // 
         ...
         export.Location = new Point(450, 591);
         export.Name = "export";
         export.Size = new Size(250, 49);
         export.TabIndex = 28;
         export.Text = "Export";
