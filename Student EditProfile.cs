...
namespace MathMind
{
   public partial class StudentEditProfile : Form
   {
      ...
      public StudentEditProfile(string username)
      {
         InitializeComponent();
      ...
      {
         string query = "SELECT FullName, Email, Password FROM StudentsAccounts WHERE Username = @Username";
         using (SqlConnection conn = new SqlConnection(connectionString))
         {
            SqlCommand cmd = new SqlCommand(query, conn);
            cmd.Parameters.AddWithValue("@Username", username);
      ...
      private void FinishClick(object sender, EventArgs e)
      {
         ...
         string query = "UPDATE StudentsAccounts SET FullName = @FullName, Email = @Email, Password = @Password, ProfilePicture = @ProfilePicture WHERE Username = @Username";
         ...
         try
         {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
               ...
               var home = new StudentHome(name, username);
      ...
      private string GetName(string username)
      {
         ...
         string query = "SELECT FullName FROM StudentsAccounts WHERE Username = @Username";
