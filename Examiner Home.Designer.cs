namespace MathMind
{
   partial class ExaminerHome
   {
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ExaminerHome));
         Title = new Label();
         Slogan = new Label();
         MQuestions = new Button();
         Back = new PictureBox();
         MRequests = new Button();
         pictureBox2 = new PictureBox();
         Welcome = new Label();
         PFP = new PictureBox();
         EditProfile = new Label();
         MGraading = new Button();
         ...
         // MQuestions
         // 
         MQuestions.BackColor = Color.Cyan;
         MQuestions.Font = new Font("Algerian", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 0);
         MQuestions.ForeColor = Color.Black;
         MQuestions.Location = new Point(392, 199);
         MQuestions.Name = "MQuestions";
         MQuestions.Size = new Size(311, 54);
         MQuestions.TabIndex = 19;
         MQuestions.Text = "Manage Questions";
         MQuestions.UseVisualStyleBackColor = false;
         MQuestions.Click += QuestionsManage;
         // 
         // Back
         // 
         ...
         // MRequests
         // 
         MRequests.BackColor = Color.Cyan;
         MRequests.Font = new Font("Algerian", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 0);
         MRequests.ForeColor = Color.Black;
         MRequests.Location = new Point(392, 259);
         MRequests.Name = "MRequests";
         MRequests.Size = new Size(311, 54);
         MRequests.TabIndex = 24;
         MRequests.Text = "Manage Requests";
         MRequests.UseVisualStyleBackColor = false;
         MRequests.Click += RequestsManage;
         // 
         // pictureBox2
         // 
         ...
         // MGraading
         // 
         MGraading.BackColor = Color.Cyan;
         MGraading.Font = new Font("Algerian", 16.2F, FontStyle.Bold, GraphicsUnit.Point, 0);
         MGraading.ForeColor = Color.Black;
         MGraading.Location = new Point(392, 319);
         MGraading.Name = "MGraading";
         MGraading.Size = new Size(311, 54);
         MGraading.TabIndex = 30;
         MGraading.Text = "Manage Grades";
         MGraading.UseVisualStyleBackColor = false;
         MGraading.Click += GradingManage;
         // 
         // ExaminerHome
         // 
         ...
         Controls.Add(MGraading);
         Controls.Add(EditProfile);
         Controls.Add(PFP);
         Controls.Add(Welcome);
         Controls.Add(pictureBox2);
         Controls.Add(MRequests);
         Controls.Add(Back);
         Controls.Add(MQuestions);
         Controls.Add(Slogan);
         Controls.Add(Title);
